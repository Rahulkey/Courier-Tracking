...
<body class="black">
     ...
     <br/>
            <table class="pagination" style="margin-left:80px;">
                <tr>
                    <td class="auto-style1">
                        <asp:Label ID="lbl_password0" runat="server" ForeColor="White" Text="Consignment Id:"></asp:Label>
                    </td>
                    <td class="auto-style4">
                        <asp:TextBox ID="txt_firstName" runat="server" Height="27px" Width="239px" ForeColor="White"></asp:TextBox>
                    </td>
                    <td class="auto-style6">
                        <asp:Label ID="lbl_password1" runat="server" ForeColor="White" Text="Customer Id:"></asp:Label>
                    </td>
                    <td>
                ...
                <tr>
                    <td class="auto-style1">
                        <asp:Label ID="lbl_firstName4" runat="server" ForeColor="White" Text="Sender Address:"></asp:Label>
                    </td>
                ...
                <tr>
                    <td class="auto-style1">
                        <asp:Label ID="lbl_firstName5" runat="server" ForeColor="White" Text="Receiver Address:"></asp:Label>
                    </td>
                    <td class="auto-style4" colspan="3">
                        <asp:TextBox ID="txt_lastName5" runat="server" Height="27px" Width="829px" ForeColor="White"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style1">
                        <asp:Label ID="lbl_EmailID1" runat="server" ForeColor="White" Text="Weight:"></asp:Label>
                    </td>
                    <td class="auto-style4">
                        <asp:TextBox ID="txt_emailId2" runat="server" Height="27px" Width="230px" ForeColor="White"></asp:TextBox>
                    </td>
                    <td class="auto-style6">
                        &nbsp;</td>
                    <td>
                ...
                <tr>
                    <td class="auto-style2">
                        <asp:Label ID="lbl_phoneNumber1" runat="server" ForeColor="White" Text="Cost:"></asp:Label>
                    </td>
                    <td class="auto-style5">
                        <asp:TextBox ID="txt_emailId3" runat="server" Height="27px" Width="230px" ForeColor="White"></asp:TextBox>
                    </td>
            ...
            <div style="margin-left: 200px">
                <br />
                 <br />
                 <button class="btn btn-large" style="background-color: #ee3a5b;"  type="submit" name="Register">GENERATE BILL</button>
            </div>
        </form>
