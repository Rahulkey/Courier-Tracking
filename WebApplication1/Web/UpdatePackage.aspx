<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdatePackage.aspx.cs" Inherits="Web.UpdatePackage" %>
            ...
            <div class="col s12 l4 offset-l4">
                ...
                <div class="card-content">
                        <div class="form-field">
                            <asp:GridView ID="grd_PackageDetails" runat="server" AutoGenerateColumns="False">
                                <Columns>
                                    <asp:HyperLinkField DataNavigateUrlFields="PackageId" DataNavigateUrlFormatString="ModifyPackage.aspx?packageId={0}" DataTextField="PackageId" HeaderText="Package Id">
                                    <HeaderStyle ForeColor="White" />
                                    <ItemStyle Font-Bold="True" Font-Size="Large" ForeColor="White" />
                                    </asp:HyperLinkField>
                                    <asp:BoundField DataField="PackageStatus" HeaderText="Package Status">
                                    <HeaderStyle ForeColor="White" />
