<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StaffHome.aspx.cs" Inherits="Web.StaffHome" %>
                ...
                <div class="container">
                   ...
                   <%--<a class="waves-effect waves-light btn" >Register</a>--%>
                       <ul id="nav-mobile" class="right hide-on-med-and-down">
                        <li><a href="#" title="Home"><i class="large material-icons">home</i></a></li>
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <div class="form-field">
                            ...
                            <a href="PackageApproval.aspx" class="btn-floating btn-large waves-effect waves-light red"><i class="material-icons">add</i></a>
                            <asp:Label ID="lbl_packageApproval" runat="server" Text="Package Approval" Font-Size="Large"></asp:Label>
                        </div><br />
